...
what_youll_make: A one-page summary of a CBSE circular, NCF update, or board notification, structured in four sections covering what changed, where it hits GSL, what GSL does next, and who owns each next step by when. Every claim traceable to the source document, every action item with an owner and a deadline.
